 ...
 */
final class Version20230906215316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('CREATE TABLE chambre (id INT AUTO_INCREMENT NOT NULL, hotel_id INT DEFAULT NULL, tarif DOUBLE PRECISION NOT NULL, superficie DOUBLE PRECISION NOT NULL, vueSurMer INT NOT NULL, chaineALaCarte INT NOT NULL, climatisation INT NOT NULL, televisionEcranPlat INT NOT NULL, telephone INT NOT NULL, chaineSatellite INT NOT NULL, chaineDuCable INT NOT NULL, coffreFort INT NOT NULL, materielDeRepassage INT NOT NULL, wifiGratuit INT NOT NULL, type INT NOT NULL, UNIQUE INDEX UNIQ_C509E4FF3243BB18 (hotel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reserver (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, chambre_id INT DEFAULT NULL, prix FLOAT NOT NULL, date_entree DATE NOT NULL, date_sortie DATE NOT NULL, nb_personne INT NOT NULL, validite INT NOT NULL, INDEX IDX_B9765E93A76ED395 (user_id), INDEX IDX_B9765E939B177F54 (chambre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
